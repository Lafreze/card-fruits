...
- **12 关主线**：全部从蓝莓开始，目标从草莓逐关提升到黄金果王；每关包含完整合成阶梯、随机叠层与开局必成的一组三消。
- **甜度狂热**：三消和物理合成持续充能，满能量进入 9 秒 FEVER，得分翻倍、磁吸强化、连击窗口延长。
- **无尽狂欢**：卡组按波次无限补充，第 2 波起随机出现大果日、冰河期、炸弹节、黄金雨、磁暴或甜度激涌；双果王触发彩虹清场。
- **Roguelike 远征**：8 段连续路线、16 件奇物三选一构筑，可发展容量、连击、爆炸、狂热、经济或救场流派。
- **果币温室**：胜负都有果币成长；永久升级开局道具、狂热储备、警戒缓冲、果币收益和远征开局奇物。
- **特殊牌与新道具**：冰冻牌需要邻卡解冻，炸弹牌会连带收取周围卡片，藤蔓牌需要剪断；支持撤回、洗牌、榨汁、清顶锤、磁核与万能果。

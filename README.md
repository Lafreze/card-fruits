...
- **Matter.js 三果位果雨**：每次三消会随机生成 1～3 颗同类水果，并自动分配到左、中、右果位依次落下；果压会提高多果雨概率与落地冲击，同果随后进入唯一配对合成。
...
- **Rogue 模式**：8 关连续挑战、16 件奇物三选一，可走容量、连击、爆炸、狂热、经济或救场流派。
- **果币温室**：胜负都有果币成长；植物会随永久升级长大，购买时触发阳光、叶片和果实效果。
- **特殊牌与道具箱**：冰冻、炸弹、藤蔓和闪电甜度牌会改变拿牌节奏；11 种道具覆盖卡槽整理、果箱合成、分果重排、催熟推进与警戒救场。

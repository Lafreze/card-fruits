...
- **中央固定落果**：每次三消默认从中央生成 1 颗同类水果；温室“丰收培育”可把固定产量提升到 5 颗，不再由概率决定。
- **可控物理果箱**：点击任意水果会朝同级伙伴方向向上弹射，既能解开底部死角，也能主动制造合成；中央落果会与最近同果建立唯一配对。
...
- **无尽模式**：卡组按波次无限补充，第 2 波起随机出现大果日、冰河期、炸弹节、黄金雨、磁暴或甜度激涌；双果王触发彩虹清场。
- **Rogue 模式**：8 关连续挑战、22 项构筑强化三选一，可走产量、弹射、重力、牌组、容量、连击或救场流派。
- **果币温室**：升级价格随等级显著提高；除永久属性外，13 种道具也要用果币配置每局携带次数，未购买的道具不会免费出现。
